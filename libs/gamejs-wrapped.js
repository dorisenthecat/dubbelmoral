...
var getCanvas = function(id) {
   ...
   canvasList.every(function(canvas) {
      if (canvas.getAttribute("id") == canvasId) {
         jsGameCanvas = canvas;
         return false;
      }
      return true;
...
var getSurface = exports.getSurface = function(id) {
   ...
   if (!SURFACE[canvasId]) {
      var canvas = getCanvas(canvasId);
      SURFACE[canvasId] = new Surface([canvas.clientWidth, canvas.clientHeight]);
      SURFACE[canvasId]._canvas = canvas;
      SURFACE[canvasId]._context = canvas.getContext('2d');
      SURFACE[canvasId]._smooth();
   }
   return SURFACE[canvasId];
};
